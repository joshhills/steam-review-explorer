    ...
    return reviewStatistics.totalReviews > 2 && (reviewStatistics.totalSwearWords.length > 1 && reviewStatistics.totalSwearWords[0][1] !== reviewStatistics.totalSwearWords[1][1]) ?
        <div>
            ...
            <ReactSpoiler>
                ...
                the most common being '{reviewStatistics.totalSwearWords[0][0]}' which appears in {reviewStatistics.totalSwearWords[0][1].toLocaleString()} review{reviewStatistics.totalSwearWords[0][1] === 1 ? '' : 's'}
            </ReactSpoiler>
        </div> : <></>
